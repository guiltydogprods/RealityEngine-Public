...
void main()
{
    ...
    vec4 vertexWorldPos = model_matrix[gl_InstanceID] * vertexPose;
    normalPose = model_matrix[gl_InstanceID] * normalPose;
    tangentPose = model_matrix[gl_InstanceID] * tangentPose;
    gl_Position = camera[VIEW_ID].view_proj_matrix * vertexWorldPos;
    ...
    vs_out.cam_pos = camera[VIEW_ID].position.xyz;

    vs_out.view_id = VIEW_ID;
    vs_out.texCoord = TexCoord;
    vs_out.position = vertexWorldPos.xyz;
}
